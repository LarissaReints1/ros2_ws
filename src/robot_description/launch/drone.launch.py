...
def generate_launch_description():
    ...
    perception_node = Node(
        ...
        parameters=[{"use_dummy_target": True}],
        output='screen'
    )
    ...
    actuation_node = Node(
            package='actuation_pkg',   # replace with your ROS 2 package
            executable='servo_driver_node', # name of your compiled node executable
            name='servo_driver_node',
            output='screen',
            parameters=[
                # Optional: you can add parameters if needed
            ],
    )
